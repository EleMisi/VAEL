...
if __name__ == "__main__":
    ...
    # Run experiments
    run_vael(config.exp_config, exp_class, exp_folder, data_folder, data_file, n_digits=config.n_digits, batch_size=config.batch_size, dataset_dimension=config.dataset_dimensions,
